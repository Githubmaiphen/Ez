...
Setting:Label("Anh Em 8/6 Mai Dinh")

Setting:Line()

Setting:Button("https://www.facebook.com/profile.php?id=100055696046957&mibextid=ZbWKwL",function()
 
 setclipboard("https://www.facebook.com/profile.php?id=100055696046957&mibextid=ZbWKwL")
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Size = UDim2.new(0, 50, 0, 50)
		imagenoti.BackgroundTransparency = 1
		imagenoti.Image = "http://www.roblox.com/asset/?id=16207220161"..tostring(logo)
